  ...
  return (
    <main className="px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-2 lg:grid-cols-4">
        {teams.map((team) => (
          <div key={team.name} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
            ...
            <p className="mt-3 inline-flex rounded-full bg-slate-950 px-3 py-1 text-xs font-black text-white">{team.format}</p>
