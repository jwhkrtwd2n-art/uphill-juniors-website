...
export function PlayerInquiryForm() {
  ...
  return (
    <div id="player-enquiry">
      ...
      {isOpen ? (
        <div
          className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-blue-950/80 p-4 backdrop-blur-sm sm:p-8"
          role="dialog"
          aria-modal="true"
          aria-labelledby="player-enquiry-title"
        >
          <form
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Complete the form and the club will check availability for
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="max-w-xl text-xs leading-5 text-slate-500">
          These details will only be used by the club to respond to this player
          enquiry and check the appropriate age group.
        </p>
        <button
          type="submit"
